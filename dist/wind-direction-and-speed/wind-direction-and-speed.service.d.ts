...
export declare class WindDirectionAndSpeedService {
    ...
    saveWindDirectionAndSpeed(dto: CreateWindDirectionAndSpeedDto, ipAddress: string, userAgent: string): Promise<{
        success: boolean;
        message: string;
    ...
    saveExcelWindDirectionAndSpeed(dto: CreateWindDirectionAndSpeedExcelDto, ipAddress: string, userAgent: string): Promise<{
        success: boolean;
        message: string;
        error: import("@supabase/supabase-js").PostgrestError | undefined;
        data?: undefined;
    ...
    updateWindDirectionAndSpeed(dto: EditWindDirectionAndSpeedDto, ipAddress: string, userAgent: string): Promise<{
        success: boolean;
        message: string;
        error: import("@supabase/supabase-js").PostgrestError | undefined;
        data?: undefined;
    ...
    deleteWindDirectionAndSpeed(id: number, user_id: string, ipAddress: string, userAgent: string): Promise<{
        success: boolean;
        message: string;
        error: import("@supabase/supabase-js").PostgrestError | undefined;
        data?: undefined;
    ...
    getWindDirectionAndSpeedById(id: number): Promise<{
        success: boolean;
        message: string;
        error: import("@supabase/supabase-js").PostgrestError | null;
        data?: undefined;
    ...
    getWindDirectionAndSpeedByDate(dto: FilterWindDirectionAndSpeedByDateDto): Promise<{
        success: boolean;
        message: string;
        error: import("@supabase/supabase-js").PostgrestError;
        data?: undefined;
